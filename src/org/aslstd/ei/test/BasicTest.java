...
public class BasicTest {
	...
	public static final void test() {
		...
		meta.setLore(Arrays.asList(AttrManager.PHYSICAL_DAMAGE.convertToLore("+", "1"),CustomParams.LEVEL.convert("8"), DManager.getDurabilityLore("10")));
		...
		if (BasicMetaAdapter.getStringValue(AttrBase.getRegexPattern(AttrManager.PHYSICAL_DAMAGE), upgrade).contains("3") &&
